...
- Technical release-candidate required gates are missing/failing: test, build, readiness, storybook-anatomy, consumer-installed-contract-markers, visual-certification-capture, visual-certification-capture-source-contract-probe, readiness-refresh, goal-completion-update, library-acceptance, goal-completion-refresh, library-consumption-status, crm-real-readiness, consumer-dependencies-sync-check, consumer-package-install-plan, consumer-lockfile, consumer-refresh, consumer-vendor-sync-check, official-library-readiness-update, official-library-readiness, goal-completion.
