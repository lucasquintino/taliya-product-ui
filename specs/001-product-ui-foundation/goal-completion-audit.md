...
| Component architecture supports reuse | `components:audit 343 valid stories`, `primitiveReuseClassification refactor=0 missingPrimitive=0` | proven-for-current-scope | Satisfied for current scope |
...
| Release channel handoff proves the local install channel is reliable for consumers | `release-channel:audit`, `release-channel-audit.md`, `status=pass-registry-release-channel`, `localTarballChannelReady=true`, `registryReady=true`, `releasePolicyStatus=pass-registry-policy`, `currentVersion=0.1.1`, `consumerPackageSyncStatus=pass`, `consumerVendorVersioningStatus=pass`, `consumerConfigVersioningStatus=pass`, `registryBlockers=0` | proven-for-current-scope | Satisfied for current scope |
...
- Official library readiness is `pass-official-library-current-scope`, with official consumer ready: `true`, package version: `0.1.1`, release-candidate gates: `103`, and registry manual items: `3`.
...
- Release channel readiness is `pass-registry-release-channel`, with local tarball channel ready: `true`, registry ready: `true`, and registry blockers: `0`.
