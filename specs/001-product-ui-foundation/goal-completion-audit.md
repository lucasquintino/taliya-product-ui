...
- Official library readiness is `pass-official-library-current-scope`, with official consumer ready: `true`, package version: `0.1.1`, release-candidate gates: `104`, and registry manual items: `3`.
