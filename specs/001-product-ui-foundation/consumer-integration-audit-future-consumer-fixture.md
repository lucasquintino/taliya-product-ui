...
- tokens-product-shell-topnav-rhythm: installed contract markers ok
- tokens-product-shell-surface-rhythm: installed contract markers ok
- ui-segmented-shell-topnav-css: installed contract markers ok
- crm-shell-topnav-nav-pill-rendering: installed contract markers ok
...
- tokens-page-quick-filter-soft-selection: installed contract markers ok
- tokens-approval-panel-history-rhythm: installed contract markers ok
- tokens-finance-priority-panel-density: installed contract markers ok
- crm-page-filter-bar-flex-flow-css: installed contract markers ok
- crm-page-filter-bar-density-api: installed contract markers ok
- crm-page-filter-bar-compact-css: installed contract markers ok
- crm-page-filter-bar-tight-css: installed contract markers ok
- crm-page-quick-filters-selection-tone-api: installed contract markers ok
- crm-page-quick-filters-soft-selection-css: installed contract markers ok
- crm-approval-panel-history-rhythm-css: installed contract markers ok
- crm-finance-priority-panel-density-css: installed contract markers ok
- crm-work-list-detail-main-priority-api: installed contract markers ok
- crm-work-list-detail-main-priority-css: installed contract markers ok
- tokens-work-list-detail-main-priority: installed contract markers ok
- ui-filter-select-value-trigger-api: installed contract markers ok
- ui-search-input-embedded-filter-api-css: installed contract markers ok
- ui-search-input-embedded-filter-css: installed contract markers ok
- crm-page-filter-bar-embedded-search-filter-api: installed contract markers ok
- tokens-compact-checklist-drawer: installed contract markers ok
- tokens-checklist-table-dot-selection: installed contract markers ok
- crm-checklist-drawer-rhythm-css: installed contract markers ok
- crm-checklist-table-dot-selection-css: installed contract markers ok
- Standard page-kit runtime manifest: pass
- Standard page-kit runtime exact parity: pass
- Standard page-kit runtime count: 52/52
- Standard page-kit runtime missing names: none
- Standard page-kit runtime missing rows: none
- Standard page-kit runtime extra rows: none
- Standard page-kit runtime order/field drift: no
