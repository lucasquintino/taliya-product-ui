...
Generated: 2026-08-13T20:17:54.099Z
...
| `package-versions-aligned` | pass | packages/tokens/package.json=0.1.2, packages/ui/package.json=0.1.2, packages/crm/package.json=0.1.2 | all public packages must share the same release version |
...
| `controlled-publish-workflow` | pass | .github/workflows/publish-packages.yml | publishing must be manual, environment-protected, authenticated through npm trusted publishing, and provenance-enabled |
