...
Generated: 2026-07-07T11:42:02.630Z
...
| `current-internal-fully-consuming` | pass | library-consumption-status.json and consumer-page-kit-audit.json | Internal consumes official shell, filters, tables, kanban, drawers, route states, and wrapper roots without local visual clones. |
