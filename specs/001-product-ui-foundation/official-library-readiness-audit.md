...
Generated: 2026-07-07T11:42:06.201Z
...
| `@taliya/tokens` | pass | 0.0.0 | package metadata supports official consumer installation |
| `@taliya/ui` | pass | 0.0.0 | package metadata supports official consumer installation |
| `@taliya/crm` | pass | 0.0.0 | package metadata supports official consumer installation |

## Registry Manual Items

- Choose a real semver version before publishing to a registry.
