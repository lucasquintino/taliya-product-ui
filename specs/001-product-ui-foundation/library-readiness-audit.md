...
| Component/story architecture | Proven for current scope | `corepack pnpm components:audit` passes; 343 component stories have valid namespaces, and CRM primitive reuse reports 32 justified compound roots, 0 refactor rows, and 0 missing-primitive rows. |
