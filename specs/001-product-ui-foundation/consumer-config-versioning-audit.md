...
Generated: 2026-07-07T11:41:35.835Z
...
Git root: `C:/Users/lucas/taliya-internal`

## Config Files

| File | Exists | JSON | Git tracked | Git status | Status |
| --- | --- | --- | --- | --- | --- |
| `taliya-readiness.config.json` | yes | valid | yes | clean/tracked | Pass |
| `taliya-page-kit.config.json` | yes | valid | yes | `M taliya-page-kit.config.json` | Pass |
