...
Generated: 2026-07-16T16:05:58.185Z
...
| --- | --- | --- | --- | --- | ---: | ---: |
| `19_round-4.1A_hoje_03_estado-critico-do-dia.png` | `crm-image-coverage-hoje--image-19-hoje-estado-critico` | captured | valid | 1672x941 | 7.92 | 5.35% |
| `79_round-4.1S_app-shell_01_base-web-sem-conteudo.png` | `crm-image-coverage-image-79-empty-shell--image-79-empty-shell` | captured | valid | 1160x868 | 2.88 | 1.01% |
| `69_round-4.1O_uso_02_extrato-aprovado.png` | `crm-image-coverage-usage--image-69-uso-extrato` | captured | valid | 1448x1086 | 10.72 | 6.29% |
| `68_round-4.1O_uso_01_visao-geral-aprovado.png` | `crm-image-coverage-usage--image-68-uso-visao-geral` | captured | valid | 1448x1086 | 9.80 | 6.25% |
...
| `25_round-4.1C_aprovacoes_01_lista-decisao-detalhe.png.png` | `crm-image-coverage-aprovacoes--image-25-lista-decisao-detalhe` | captured | valid | 1448x1086 | 11.38 | 7.87% |
| `26_round-4.1F_agenda_01_calendario-operacional.png.png` | `crm-image-coverage-agenda--image-26-agenda-calendario-operacional` | captured | valid | 1448x1086 | 14.82 | 8.67% |
| `27_round-4.1E_alunos_01_lista-perfil-resumido.png.png` | `crm-image-coverage-alunos--image-27-lista-perfil-resumido` | captured | valid | 1448x1086 | 13.92 | 8.12% |
| `28_round-4.1E_aluno-perfil_01_resumo-operacional.png.png` | `crm-image-coverage-alunos--image-28-aluno-perfil-resumo-operacional` | captured | valid | 1448x1086 | 14.52 | 11.13% |
| `29_round-4.1F_aula_01_detalhe-com-chamada.png.png` | `crm-image-coverage-agenda--image-29-aula-detalhe-com-chamada` | captured | valid | 1487x1058 | 14.55 | 8.26% |
...
| `38_round-4.1G_vendas_02_lista-interessados.png.png` | `crm-image-coverage-vendas--image-38-lista-interessados` | captured | valid | 1448x1086 | 13.89 | 8.38% |
| `39_round-4.1G_experimental_01_lista-acompanhamento.png.png` | `crm-image-coverage-vendas--image-39-experimental-lista` | captured | valid | 1448x1086 | 13.54 | 8.56% |
| `40_round-4.1G_matriculas_01_checklist-conversao.png.png` | `crm-image-coverage-vendas--image-40-matriculas-checklist-conversao` | captured | valid | 1448x1086 | 12.36 | 7.64% |
| `41_round-4.1H_retencao_01_riscos-lista-drawer.png.png` | `crm-image-coverage-retencao--image-41-retencao-riscos` | captured | valid | 1672x941 | 15.36 | 9.05% |
| `42_round-4.1H_cancelamentos_01_fila-salvamento-drawer.png.png` | `crm-image-coverage-retencao--image-42-cancelamentos-fila` | captured | valid | 1672x941 | 13.70 | 8.31% |
| `43_round-4.1H_reativacoes_01_ex-alunos-retorno.png.png` | `crm-image-coverage-retencao--image-43-reativacoes-ex-alunos` | captured | valid | 1659x948 | 14.43 | 8.57% |
| `44_round-4.1H_reclamacoes_01_fila-caso-sensivel-drawer.png.png` | `crm-image-coverage-retencao--image-44-reclamacoes-caso-sensivel` | captured | valid | 1672x941 | 13.88 | 8.53% |
| `45_round-4.1I_relatorios_01_visao-gestao.png.png` | `crm-image-coverage-relatorios--reports-management` | captured | valid | 1672x941 | 10.01 | 5.86% |
| `46_round-4.1I_dinheiro-na-mesa_01_oportunidades-por-origem.png.png` | `crm-image-coverage-relatorios--money-on-the-table` | captured | valid | 1586x992 | 13.43 | 8.52% |
| `47_round-4.1J_suporte_01_central-studio-taliya.png.png` | `crm-image-coverage-suporte--support-central` | captured | valid | 1586x992 | 14.40 | 8.30% |
...
| `51J_round-4.1J_onboarding_bloco-7-agenda-aprovado.png` | `crm-image-coverage-setup--image-51-j-onboarding-agenda` | captured | valid | 1672x941 | 13.80 | 9.17% |
| `51L_round-4.1J_onboarding_bloco-9-revisao-aprovado.png` | `crm-image-coverage-setup--image-51-l-onboarding-revisao` | captured | valid | 1672x941 | 13.71 | 9.47% |
| `78_round-4.1Q_onboarding_bem-vindo-taliya-setup-guiado-aprovado.png` | `crm-image-coverage-setup--image-78-onboarding-bem-vindo` | captured | valid | 1672x941 | 8.42 | 3.97% |
| `52_round-4.1L_agentes_01_catalogo-agentes-aprovado.png` | `crm-image-coverage-agentes--image-52-agentes-catalogo` | captured | valid | 1672x941 | 9.59 | 6.84% |
| `53_round-4.1L_agentes_02_agente-agenda-rotinas-aprovado.png` | `crm-image-coverage-agentes--image-53-agente-agenda-rotinas` | captured | valid | 1491x1055 | 14.32 | 12.50% |
| `54_round-4.1L_agentes_03_rotina-presenca-faltas-aprovado.png` | `crm-image-coverage-agentes--image-54-rotina-presenca-faltas` | captured | valid | 1536x1024 | 14.33 | 9.19% |
| `56_round-4.1L_agentes_04_fluxo-falta-com-aviso-v2-aprovado.png` | `crm-image-coverage-agentes--image-56-fluxo-falta-com-aviso` | captured | valid | 1672x941 | 10.22 | 7.81% |
| `58_round-4.1L_agentes_05_teste-fluxo-falta-com-aviso-aprovado.png` | `crm-image-coverage-agentes--image-58-teste-fluxo-falta-com-aviso` | captured | valid | 1672x941 | 12.45 | 8.40% |
