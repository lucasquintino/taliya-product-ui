...
Generated: 2026-07-07T11:42:04.841Z

Consumer: `C:\Users\lucas\taliya-internal`

Source: `C:\Users\lucas\taliya-product-ui\dist-packages`

Vendor: `C:\Users\lucas\taliya-internal\vendor\taliya-product-ui`
...
| `@taliya/tokens` | `dist/index.d.ts` | yes | yes | `0ac15806f161` | `0ac15806f161` | pass |
| `@taliya/tokens` | `dist/index.js` | yes | yes | `8e77b1092135` | `8e77b1092135` | pass |
| `@taliya/tokens` | `src/tokens.css` | yes | yes | `832c0a3283c1` | `832c0a3283c1` | pass |
| `@taliya/ui` | `README.md` | yes | yes | `bea1ba76face` | `bea1ba76face` | pass |
| `@taliya/ui` | `dist/index.d.ts` | yes | yes | `ce2d6fcabd7e` | `ce2d6fcabd7e` | pass |
| `@taliya/ui` | `dist/index.js` | yes | yes | `25f34d7f4c68` | `25f34d7f4c68` | pass |
| `@taliya/ui` | `src/styles.css` | yes | yes | `8c2e4a394e7b` | `8c2e4a394e7b` | pass |
| `@taliya/crm` | `README.md` | yes | yes | `180712aa6b5a` | `180712aa6b5a` | pass |
| `@taliya/crm` | `dist/index.d.ts` | yes | yes | `2d2e3d5108fb` | `2d2e3d5108fb` | pass |
| `@taliya/crm` | `dist/index.js` | yes | yes | `6fb40af9700f` | `6fb40af9700f` | pass |
...
| `@taliya/crm` | `src/styles.css` | yes | yes | `3300fe230173` | `3300fe230173` | pass |
