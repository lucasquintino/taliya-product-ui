...
export function toneForState(state?: string): ComponentTone {
  ...
  if (["draft", "mapped", "request-access", "candidate", "assigned", "answered", "access-active", "scheduled", "due", "validation", "manual", "manual-disponivel", "disponivel"].includes(normalized)) return "info";
